      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6 mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Chat Configuration</p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 text-sm bg-gray-100 text-gray-700 hover:bg-gray-200 rounded-md transition-colors"
          >
            <Settings className="w-4 h-4" />
            <span>{isSettingsOpen ? "Close Settings" : "Open Settings"}</span>
          </button>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                handleUpdateField("systemPrompt", e.target.value)
              }
              rows={4}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
